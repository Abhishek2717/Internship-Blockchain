...
coin.addBlock(new Block(1 , "9/10/2021" , { Name: 'Abhishek Pal' , phLevel: '7' ,  moistureLevel: '35'}));

console.log("Mining Block 2..")
coin.addBlock(new Block(2 , "17/10/2021" , {Name :  'Aaditya Negi' , phLevel:'3' , moistureLevel: '72'}));

console.log("Mining Block 3..")
coin.addBlock(new Block(2 , "17/10/2021" , {Name :  'Tanya' , phLevel:'4' , moistureLevel: '92'}));

console.log("Mining Block 4..")
coin.addBlock(new Block(2 , "17/10/2021" , {Name :  'Riya' , phLevel:'6' , moistureLevel: '35'}));

console.log("Mining Block 5..")
coin.addBlock(new Block(2 , "17/10/2021" , {Name :  'Aadi' , phLevel:'5' , moistureLevel: '23'}));
